    ...
    if(this.state.fetchingData){
      ...
      return(
        <div className="col-16-tool-strip">
          <a className="c2a-button-col16">{data.buttons[0].text}</a>
          <a className="c2a-button-col16" style={{marginLeft: 0}}>{data.buttons[1].text}</a>
        </div>
      )
    }
  }
    ...
    if(this.state.fetchingData){
      ...
      return(
        <div className="col-4-tool-strip col-4-mobile">
          <a className="c2a-button-col4">{data.buttons[0].text}</a>
          <a className="c2a-button-col4" style={{marginTop: 0}}>{data.buttons[1].text}</a>
        </div>
      )      
    }
  }
